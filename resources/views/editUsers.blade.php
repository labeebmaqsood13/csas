                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <input  class="form-control-static" value="Faisal"></input>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input  class="form-control-static" value="Mahmood"></input>
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Email</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input  class="form-control-static" value="faisalrocky1@yahoo.com"></input>
                          </div>
                      </div>
                      <div class="form-group">
